...
namespace OpenLogReplicator {
    ...
    public:
        ...
        OracleAnalyzerOnline(OutputBuffer *outputBuffer, const char *alias, const char *database, uint64_t dumpRedoLog,
                ...
                const char *password, const char *connectString, bool isStandby);
