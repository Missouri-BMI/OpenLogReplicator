...
namespace OpenLogReplicator {
    ...
    public:
        ...
        OracleAnalyzerOnlineASM(OutputBuffer *outputBuffer, const char *alias, const char *database, uint64_t dumpRedoLog,
                uint64_t dumpData, uint64_t flags, uint64_t disableChecks, uint64_t redoReadSleep, uint64_t archReadSleep,
                uint64_t redoVerifyDelay, uint64_t memoryMinMb, uint64_t memoryMaxMb, uint64_t readBufferMax,
                const char *logArchiveFormat, const char *savepointPath, const char *redoCopyPath, const char *user,
                const char *password, const char *connectString, const char *userASM, const char *passwdASM,
