...
namespace OpenLogReplicator {
    ...
    OracleAnalyzerOnlineASM::OracleAnalyzerOnlineASM(OutputBuffer *outputBuffer, const char *alias, const char *database, uint64_t trace,
            ...
            const char *savepointPath, const char *user, const char *password, const char *connectString, const char *userASM,
            ...
            disableChecks, redoReadSleep, archReadSleep, redoVerifyDelay, memoryMinMb, memoryMaxMb, logArchiveFormat, savepointPath, user,
