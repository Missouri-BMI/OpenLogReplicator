...
namespace OpenLogReplicator {
    ...
    OracleAnalyzerOnlineASM::OracleAnalyzerOnlineASM(OutputBuffer *outputBuffer, const char *alias, const char *database, uint64_t trace,
            ...
            const char *logArchiveFormat, const char *savepointPath, const char *user, const char *password, const char *connectString,
            ...
            savepointPath, user, password, connectString, isStandby),
            userASM(userASM),
